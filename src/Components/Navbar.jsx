...
const Navbar = () => {
  ...
  return (
    <div className='bg-white/10 mx-auto items-center backdrop-blur-lg mt-3 relative z-50 w-full h-16 flex justify-between px-10 py-3 rounded-full'>
        ...
        <div className='w-1/3 flex gap-4 font-montserrat '>
